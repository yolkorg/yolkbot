...
const isNode = typeof process !== 'undefined' && typeof navigator !== 'undefined' && navigator.userAgent?.startsWith('Node.js/');
...
globals.WebSocket = isBrowser || isWorker ? globalThis.WebSocket : (await import('ws')).default; 
