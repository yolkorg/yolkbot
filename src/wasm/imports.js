...
export const imports = {
    wbg: {
        __wbg_addEventListener_90e553fdce254421: (_t, arg1, arg2, callback) =>
            canvasListeners[getStringFromWasm(arg1, arg2)] = callback,
        __wbg_appendChild_8204974b7328bf98: () => { },
        __wbg_axes_b1da727bd9ea422d: () => { },
        __wbg_body_942ea927546a04ba: (...args) => addToExternrefTable(args[0].body),
        __wbg_call_672a4d21634d4a24: () => { },
        __wbg_childNodes_c4423003f3a9441f: () => [],
        __wbg_createElement_8c9931a732ee2fea: () => element,
        __wbg_document_d249400bd7bd996d: () => addToExternrefTable(mockWindow.document),
        __wbg_from_2a5d3e218e67aa85: (...args) => Array.from(args[0]),
        __wbg_getElementById_f827f0d6648718a8: () => addToExternrefTable({}),
        ...
        __wbg_item_8be407c958853a13: (...args) => addToExternrefTable(args[0][args[1] >>> 0]),
        ...
        __wbg_now_807e54c39636c349: () => dateToUse || Date.now(),
        ...
        __wbg_static_accessor_SELF_37c5d418e4bf5819: () => addToExternrefTable(mockWindow),
        __wbg_static_accessor_WINDOW_5de37043a91a9c40: () => { },
        __wbg_textContent_215d0f87d539368a: (outPtr, targetElement) => {
            const [ptr, len] = passStringToWasm(targetElement === element ? element.textContent : magicString);
