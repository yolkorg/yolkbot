...
export const Language = {
    ...
    "signin_msg_chat": "Note* Burner email accounts can’t chat",
    ...
    "item_gre_banana_title": "The Banana Grenade",
    "item_gre_banana_desc": "chicken... BANANA!",
    "item_hat_kartbros_title": "The Green Machine",
    "item_hat_kartbros_desc": "Lean, Mean, Green!",
    "item_gre_crab_title": "The Crab Rave Grenade",
    "item_gre_crab_desc": "A Musical Masterpiece",
    "item_hat_shell_title": "The Shimmer-Shell ",
    "item_hat_shell_desc": "Be shellfish, you deserve it",
    "bun_kill_title": "The Kill Streaker",
    "bun_kill_desc": "Crack 'em and Rack 'em",
    "bun_ridge_title": "Ridge Racer",
    "bun_ridge_desc": "Start the revolution!",
    ...
    "generic_error_title": "Uh oh",
    "generic_error_content": "There was a problem. Try reloading the game.",
    ...
    "faqItems_q1_anchor": "About this game",
    "faqItems_q1_q": "What is Shell Shockers?",
    "faqItems_q1_a": "<p>Shell Shockers is the ultimate free-to-play multiplayer FPS (first-person shooter) game! Loved by gamers worldwide, this browser-based IO game features egg-cellent gameplay, vibrant maps, fast-paced shooting action, & hilarious yolk-filled chaos. Become the top egg on the battlefield by cracking your opponents before they scramble you!</p>",
    "faqItems_q2_anchor": "F2P",
    "faqItems_q2_q": "Is Shell Shockers Free?",
    "faqItems_q2_a": "<p>Yes! Shell Shockers is completely free to play (F2P) directly from your web browser - no downloads required. Jump right into the online multiplayer action on your chromebook, PC or Mac without any paywalls, subscriptions, or hidden fees.</p>",
    "faqItems_q3_anchor": "Safe?",
    "faqItems_q3_q": "Is Shell Shockers Safe?",
    "faqItems_q3_a": "<p>Absolutely! Shell Shockers is a safe online multiplayer game suitable for teens, kids and players of all ages. Created by a trusted game developer, Blue Wizard Digital, it offers gated chat to ensure a fun, friendly, and secure environment. As always, players should use caution, practice safe online gaming, and never share sensitive personal information in-game. Parents can confidently allow their kids to play, knowing they're engaging with a reputable and moderated community.</p>",
    "faqItems_q4_anchor": "How 2 Play",
    "faqItems_q4_q": "How do I play Shell Shockers",
    "faqItems_q4_a": "<p>Playing Shell Shockers is as easy as cracking an egg! Simply head to shellshock.io, pick your favorite game mode (Free For All, Teams, Captula the Spatula or King of the Coop), customize your egg with hats, weapon skins and stamps, then click Play! Move using the classic WASD keys, aim with your mouse, and click on enemy eggs. It’s simple to play but hard to master! Longer play will improve FPS skills, aim, and multiplayer awareness as you dominate your friends and egg rivals!</p>",
    "faqItems_q5_anchor": "Best Weapon?",
    "faqItems_q5_q": "What is the Best Gun in Shell Shockers?",
    "faqItems_q5_a": "<p>The best gun in Shell Shockers depends on your gameplay style, but trending fan favorites include the powerful Crackshot, a bolt action sniper rifle for precise egg-sniping and the versatile Scrambler, a shotgun for epic close-range yolk explosions. Experiment, find your playstyle, and dominate like a true egg warrior!</p>",
    "faqItems_q6_anchor": "Controls",
    "faqItems_q6_q": "How do I throw a grenade, melee or inspect a weapon?",
    "faqItems_q6_a": "<p>INSERT INSTRUCTION POPUP</p>",
    "faqItems_q7_anchor": "Bugs",
    "faqItems_q7_q": "Are you aware of this bug?",
    "faqItems_q7_a": "<p>Probably, but <b>reports</b> are always useful! Here are some known issues we're currently battling:</p>\n<ul>\n  <li>Sometimes your gun and pistol will swap ammo; despawning and changing your weapon should fix this.</li>\n  <li>If you notice you are not getting Eggs for kills, please reload the page.</li>\n  <li>Occasionally instead of the eggdoll you see a massive weapon that takes up the whole screen. This one is kinda fun!</li>\n  <li>Ads sometimes can be more aggressive than intended! Right click, save URL and send to us here.</li>\n</ul>",
    "faqItems_q8_anchor": "High Ping / Lag",
    "faqItems_q8_q": "High Ping / Lag - What should I do?",
    "faqItems_q8_a": "<p>You can see your ping in the upper-right corner of the game window as you play. Generally speaking, a ping of less than 100ms is preferable but as long as your ping is consistent Shell Shockers is very playable!</p>\n<p>If your movement is juddering or your shots seem to fire late, here are a few things you can try:</p>\n<ul>\n  <li>Close any other open tabs.</li>\n  <li>Pause or cancel any active downloads or streams on your network. Turn off that cat video!</li>\n  <li>Close any file‑sharing applications.</li>\n  <li>Close apps that download in the background (Steam, etc.)</li>\n  <li>Try a different server closer to your location.</li>\n  <li>Chastise your family for using all the bandwidth.</li>\n  <li>Restart your router.</li>\n  <li>If you're on WiFi, try a wired connection if you can.</li>\n</ul>\n<p>Lag spikes (when your ping momentarily shoots upward) will absolutely ruin your day, though, and there is unfortunately no way for the game to compensate for them.</p>",
    "faqItems_q9_anchor": "Low FPS",
    "faqItems_q9_q": "My Frames per Second (FPS) are low. Now what?",
    "faqItems_q9_a": "<p>Frame rate is indicated by the FPS readout in the upper-right corner of the game window. Generally, 60 is best unless you have an upgraded monitor.</p>\n<ul>\n  <li>Try closing other apps, browsers, & tabs.</li>\n  <li>Open Settings & turn off Auto Detail, then un-check High Resolution and Shadows (if enabled).</li>\n  <li>If you're running multiple displays, try moving your browser window to another one.</li>\n  <li>Sometimes you may have accidentally zoomed in or out. Try zooming in or out to 100% (CTRL & mouse wheel) and see if it makes a difference.</li>\n  <li>Install the latest video drivers for your card.</li>\n  <li>If your GPU is on Chrome's blacklist, it might be using a software renderer known as \"SwiftShader\", which is terribly slow. Enter chrome://flags in your address bar, search for \"Override software rendering list\", and enable it. CAUTION: The blacklist exists for a reason. This may make your system unstable. Make sure you save anything you’re working on before trying this!</li>\n</ul>\n<p>If you're running Chrome, try enabling Experimental Canvas 2D API features:</p>\n<ul>\n  <li>Enter chrome://flags in the address bar.</li>\n  <li>Type \"canvas\" in the search box.</li>\n  <li>Find \"Experimental Canvas 2D API features\" and enable it.</li>\n  <li>Restart Chrome.</li>\n</ul>\n<p>This may make it better, or worse. Good luck with that.</p>",
    "faqItems_q10_anchor": "Chat",
    "faqItems_q10_q": "Why can't I chat?",
    "faqItems_q10_a": "<p>To chat in-game do the following in order:</p>\n<ul>\n  <li>Create an account.</li>\n  <li>Verify the account via the email sent to your inbox.</li>\n  <li>Signing in with Google automatically verifies!</li>\n</ul>",
    "faqItems_q11_anchor": "Mouse weirdness",
    "faqItems_q11_q": "My Mouse keeps making sudden movements!",
    "faqItems_q11_a": "<p>This is caused by the DPI on your mouse being high interacting with a browser game! In almost all cases, you can fix this by clicking 'Fix Mouse Glitch' on the first page of your Settings.",
    "faqItems_q12_anchor": "Updates",
    "faqItems_q12_q": "When do you update?",
    "faqItems_q12_a": "<p>We try to update on the 1st of the month around 1:30pm PST, or as close to it as we can get with weekends or holidays. We also try not to update on Mondays or Fridays to fix any live bugs ASAP!</p>",
    "faqItems_q13_anchor": "Account sharing",
    "faqItems_q13_q": "Can I share my account?",
    "faqItems_q13_a": "<p>Account sharing isn’t allowed as sharing your account details with anyone can lead to the account being abused or worse, stolen! In addition two players cannot play on an account at the same time!</p>",
    "faqItems_q14_anchor": "Trackpad shooting",
    "faqItems_q14_q": "Trackpad - Why can't I shoot?",
    "faqItems_q14_a": "<p>Some systems have a problem with registering trackpad taps while in Pointer Lock. A full click of the pad, while annoying, I know, should do the trick. Please try another browser, or check your permissions by clicking the settings button in your URL bar.</p>",
    "faqItems_q15_anchor": "Trackpad movement",
    "faqItems_q15_q": "Trackpad - Why can’t I move?",
    "faqItems_q15_a": "<p>Some systems have palm-cancelling software enabled by default, which prevents simultaneous keyboard and trackpad/mouse input. Check your system settings for palm cancelling/rejection & turn down the sensitivity or disable it altogether.</p>",
    "faqItems_q16_anchor": "More content",
    "faqItems_q16_q": "When will you add more guns/maps/modes??",
    "faqItems_q16_a": "<p>Always! New Maps are added monthly and we are constantly looking at eggscellent future features! Shell Shockers is developed by a small team, so it's going to take a little time. Rest assured, the game is in active development, & when new features are ready, you'll find them in the changelog!</p>",
    "faqItems_q17_anchor": "Shell Shockers blocked",
    "faqItems_q17_q": "Shell Shockers is blocked at School / Home / Work!",
    "faqItems_q17_a": "<p>Wanting to play Shell Shockers Unblocked - No problem! Try one of our proxy domains: www.eggcombat.com & get back to cracking some eggs. No fear if it's blocked too - The full list can be found on our Discord Server or at https://sites.google.com/bluewizard.com/play-shell/home</p>",
    "faqItems_q18_anchor": "Recommended Browser",
    "faqItems_q18_q": "Recommended Browser = Chrome",
    "faqItems_q18_a": "<p>Although Shell Shockers works on a range of web browsers, it works best and is optimised for Chrome! If you have a bug and you are on a non-chrome browser, make the switch and it will likely help!</p>",
    "faqItems_q19_anchor": "System requirements",
    "faqItems_q19_q": "System requirements",
    "faqItems_q19_a": "<ul>\n  <li>A mouse (or trackpad) & keyboard.</li>\n  <li>2.0Ghz processor.</li>\n  <li>4GB RAM.</li>\n  <li>A graphics accelerator that supports WebGL.</li>\n  <li>A broadband connection.</li>\n  <li>A WebGL and WebSocket-compatible browser. We recommend Chrome.</li>\n</ul>",
